        ...
        >
          ...
          <div className="px-8 pb-8 space-y-5">
            ...
            <div className="pt-4 border-t border-white/20">
              ...
              <span
                className={`inline-flex items-center gap-2 px-5 py-3 rounded-full text-sm font-medium ${getStatusColor(inquiry.status)}`}
              >
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-6">
      <div className="max-w-7xl mx-auto">
        <div className="mb-8 text-center">
          <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text text-transparent">
            Course Inquiries Dashboard
          </h1>
          <p className="text-gray-400">
            Manage and track all course contact inquiries
          </p>
        </div>
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-2xl shadow-2xl p-4 mb-6 border border-white/10">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {["all", "pending", "contacted", "enrolled", "rejected"].map(
              (status) => (
                <button
                  key={status}
                ...
                <tbody className="divide-y divide-white/10">
                  {filteredInquiries.map((inquiry) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span
                          className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(inquiry.status)}`}
                        >
                          {getStatusIcon(inquiry.status)}
                          {inquiry.status}
                        </span>
