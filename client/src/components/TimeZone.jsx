      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg">
            Convert Indian Standard Time to any timezone worldwide
          </p>
        </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      handleTimeInputChange("period", e.target.value)
                    }
                    className="w-full px-3 py-3 border border-white/20 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500 bg-white/5 text-white transition-all"
                  >
                    <option value="AM" className="bg-slate-800 text-white">
                      AM
                    </option>
                    <option value="PM" className="bg-slate-800 text-white">
                      PM
                    </option>
                  </select>
                </div>
              ...
              {istTime && (
                <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="font-mono text-lg font-semibold bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 bg-clip-text text-transparent">
                      {istTime}
                    </span>
                  </div>
                </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl shadow-2xl p-6 border border-white/10 relative overflow-visible dropdown-container">
            ...
            <div className="relative z-40">
              ...
              >
                ...
                <ChevronDown
                  className={`text-purple-400 transition-transform ${isDropdownOpen ? "rotate-180" : ""}`}
                  size={20}
                />
              </button>
